...
urlpatterns = [
    ...
    path('post/<int:pk>/edit-comment/', edit_comment, name='edit-comment'),
    path('post/<int:pk>/delete-comment/', delete_comment, name='delete-comment'),

    # Tag filtering: List posts by tag

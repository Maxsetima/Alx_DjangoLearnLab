...
SECRET_KEY = 'django-insecure-mfz-93*-yshhufr7*h^zlmg+3e-+-hj&xp31f-1mj44@krz_af'
...
# Example of default pagination settings for DRF
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 10,  # Limit API results to 10 per page
}
